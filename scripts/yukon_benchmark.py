...
def parse_framed_csv(path: Path, expected_count: int) -> tuple[int, dict[str, object]]:
    clean: dict[str, int] = {}
    dirty: dict[str, int] = {}
...
def write_score(
    ...
    try:
        score, metrics = (
            parse_framed_csv(csv_path, track.vector_count)
            if track.framed
            else parse_modexp_csv(csv_path, track.vector_count)
        )
